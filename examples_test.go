...
import (
	...
	"github.com/moredure/xrod/lib/cdp"
...
// Doc for environment variables: https://pkg.go.dev/github.com/moredure/xrod/lib/defaults
...
// List of cdp API: https://github.com/moredure/xrod/tree/master/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/moredure/xrod/blob/master/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
